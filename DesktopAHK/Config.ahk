...
class BC_Config {
    ...
    static LiveSummaryJsonPath := BC_Config.StateDir "\latest-summary.json"
    static LiveSummaryTextPath := BC_Config.StateDir "\latest-summary.txt"
